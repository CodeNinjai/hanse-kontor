...
- **Hafenbild:** Der Südkai ist über einen Meter weiter ins Wasser gebaut, damit Gehweg, Ladung und Kräne nebeneinander Platz haben; alles bleibt hinter der Kaimauerkrone, damit nichts über dem Wasser zu schweben scheint. Passanten laufen auf festen Bahnen: Für jede Wegstrecke ist einmal geprüft, welche seitlichen Spuren durchgehend frei von Requisiten, Häusern und Wasser sind, und jeder Passant wählt eine davon. Weil seine Bahn damit eine Gerade bleibt und der Spurwechsel am Knoten weich überblendet wird, kann niemand mehr ruckartig versetzt werden. Auf den Stegen laufen sie auf den Planken statt darunter, und die Krone der Kaimauer ist als Sperrfläche ausgewiesen, damit niemand vorn an der Kante steht und im Wasser zu stehen scheint. Am Kai stehen drei Tretradkräne mit begehbarem Laufrad und schwenkbarem Ausleger. Jeder Kran gehört zu einem festen Liegeplatz und arbeitet nur, solange dort ein Schiff festgemacht hat: Er hievt die Kiste aus dem Rumpf, schwenkt sie an Land, setzt sie auf dem Kai ab und holt den leeren Haken zurück. Steht kein Schiff am Platz, hängt der Haken still über dem Wasser. Jedes Schiff behält seinen Liegeplatz, bis es ausläuft, damit beim Auslaufen eines Nachbarn niemand mehr seitwärts an den Kai rutscht. Auch das Wachschiff der Stadt und die Fischerboote lassen sich anklicken. Schiffe am Liegeplatz haben das Segel auf die Rah gegeit und tragen das Wappen ihrer Heimatstadt als Schild am Achterkastell; unter Segel bleibt das Wappen im Tuch. Kisten, Fässer, Netze und Holzstapel säumen die Kaikante.
