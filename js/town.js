...
HK.PROPS = [
  ...
  { t: 'cross', x: 9.9, y: 18.62 }, { t: 'ropes', x: 13.9, y: 18.6 }, { t: 'sails', x: 24.9, y: 18.6 }, { t: 'barrels', x: 11.0, y: 18.5 }, { t: 'barrels', x: 18.6, y: 18.5 }, { t: 'barrels', x: 23.4, y: 18.5 }, { t: 'crates', x: 10.4, y: 18.34 }, { t: 'nets', x: 12.6, y: 18.26 }, { t: 'crates', x: 16.7, y: 18.34 }, { t: 'crates', x: 22.4, y: 18.34 }, { t: 'nets', x: 24.1, y: 18.26 }, { t: 'crates', x: 20.0, y: 18.34 }, { t: 'barrels', x: 17.4, y: 18.5 }, { t: 'crates', x: 12.0, y: 18.34 }, { t: 'crane', x: 15.0, y: 18.4 }, { t: 'crane', x: 21.4, y: 18.4 },
];
