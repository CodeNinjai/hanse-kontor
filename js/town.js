...
HK.BUILDINGS = [
  ...
  { id: 'customs',   kind: 'eave',   x: 7.4,  y: 11.0, w: 1.6, d: 1.3, h: 1.1, wall: '#d9cdb2', roof: '#564c42', flagpole: true, panel: 'customs', name: { de: 'Zollhaus', en: 'Customs house' } },
  ...
  { id: 'bank',      kind: 'eave',   x: 18.3, y: 6.2,  w: 1.4, d: 1.2, h: 1.3, wall: '#cfc6b4', roof: '#4b4239', stone: true, sign: 'bank', panel: 'bank', name: { de: 'Geldwechsler', en: 'Money changer' } },
  ...
  { id: 'f6',        kind: 'gable',  x: 21.7, y: 8.0,  w: 1.6, d: 1.2, h: 1.2, wall: '#e4d6b8', roof: '#554843', name: { de: 'Bürgerhaus', en: 'Townhouse' } },
  // Block Süd-West
  ...
  { id: 'f9',        kind: 'eave',   x: 16.2, y: 12.3, w: 1.4, d: 1.1, h: 1.1, wall: '#e4d6b8', roof: '#554843', name: { de: 'Bürgerhaus', en: 'Townhouse' } },
  ...
  { id: 'f15',       kind: 'eave',   x: 11.9, y: 14.6, w: 1.6, d: 1.1, h: 1.0, wall: '#d8c9a6', roof: '#554843', name: { de: 'Bürgerhaus', en: 'Townhouse' } },
  ...
  { id: 'sailmaker', kind: 'eave',   x: 24.7, y: 16.85, w: 1.5, d: 1.15, h: 1.0, wall: '#e4d6b8', roof: '#554843', sign: 'sail', panel: 'venture', name: { de: 'Segelmacherei', en: 'Sailmaker' } },
  { id: 'harbourmaster', kind: 'eave', x: 26.4, y: 16.8, w: 1.2, d: 1.2, h: 1.2, wall: '#cfc6b4', roof: '#4b4239', stone: true, flagpole: true, panel: 'harbourmaster', name: { de: 'Hafenmeisterei', en: "Harbour master's office" } },
  ...
  { id: 'dyer',      kind: 'eave',   x: 26.2, y: 12.9, w: 1.2, d: 1.1, h: 1.0, wall: '#d8c9a6', roof: '#4b4239', dyeCloths: true, panel: 'venture', name: { de: 'Färberei', en: 'Dye works' } },
  { id: 'school',    kind: 'school', x: 24.7, y: 14.5, w: 1.5, d: 1.2, h: 1.3, stone: true, wall: '#cfc6b4', roof: '#4b4239', sign: 'book', panel: 'school', name: { de: 'Lateinschule', en: 'Latin school' } },
  ...
  { id: 'weighhouse', kind: 'eave',  x: 16.9, y: -1.9, w: 1.5, d: 1.2, h: 1.3, stone: true, wall: '#cfc6b4', roof: '#4b4239', sign: 'scale', panel: 'weighhouse', name: { de: 'Stadtwaage', en: 'Weigh house' } },
  ...
  { id: 'f21',       kind: 'gable',  x: 22.2, y: -1.9, w: 1.0, d: 1.1, h: 1.1, wall: '#d8c9a6', roof: '#554843', name: { de: 'Bürgerhaus', en: 'Townhouse' } },
  { id: 'goldsmith', kind: 'gable',  x: 12.2, y: 0.95, w: 1.3, d: 0.9, h: 1.2, wall: '#e8dcc0', roof: '#4b4239', sign: 'ring', panel: 'venture', name: { de: 'Goldschmied', en: 'Goldsmith' } },
  ...
  { id: 'f25',       kind: 'eave',   x: 24.6, y: 0.95, w: 1.4, d: 0.9, h: 1.0, wall: '#d6c8aa', roof: '#554843', name: { de: 'Bürgerhaus', en: 'Townhouse' } },
  ...
  { id: 'arsenal',   kind: 'hall',   x: 28.4, y: 16.2, w: 1.5, d: 1.3, h: 1.4, stone: true, wall: '#9a9284', roof: '#3b352d', banner: 'red', panel: 'arsenal', name: { de: 'Zeughaus', en: 'Arsenal' } },
  { id: 'pilot',     kind: 'gable',  x: 30.2, y: 16.4, w: 1.0, d: 1.0, h: 1.0, wall: '#d9cdb2', roof: '#564c42', sign: 'anchor', name: { de: 'Lotsenhaus', en: "Pilot's house" } },
...
HK.STATIC_NPCS = [
  ...
  { person: 'weighmaster', x: 17.7, y: -0.3, color: '#474139' },
];
HK.WALKER_TYPES = [
  { id: 'citizen', weight: 6, colors: ['#7a5a3a', '#5a6a4a', '#6a4a6a', '#4a5a7a', '#8a6a3a', '#7a3a3a', '#3a5a5a'] },
  { id: 'merchant', weight: 2, colors: ['#7a3a38', '#3e5272', '#44613f', '#553a56'] },
