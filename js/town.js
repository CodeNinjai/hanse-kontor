...
HK.PROPS = [
  { t: 'crates', x: 8.9, y: 5.0 }, { t: 'barrels', x: 9.0, y: 9.4 }, { t: 'crates', x: 7.6, y: 9.7 }, { t: 'barrels', x: 7.7, y: 10.4 }, { t: 'crane', x: 7.85, y: 12.2, face: 'west' }, { t: 'barrels', x: 17.9, y: 7.7 }, { t: 'well', x: 12.05, y: 9.05 }, { t: 'statue', x: 13.5, y: 8.2 }, { t: 'pillory', x: 14.4, y: 9.2 }, { t: 'crates', x: 5.0, y: 5.6 }, { t: 'nets', x: 8.6, y: 0.9 }, { t: 'nets', x: 9.9, y: -0.4 }, { t: 'laundry', x: 18.9, y: 9.35 }, { t: 'crates', x: 22.1, y: 9.6 }, { t: 'barrels', x: 16.0, y: 4.7 }, { t: 'kiln', x: 26.1, y: 13.05 }, { t: 'frames', x: 27.55, y: 14.65 }, { t: 'dyecloths', x: 27.55, y: 13.0 }, { t: 'gallows', x: 30.6, y: 7.6 }, { t: 'tollbar', x: 29.6, y: 10.0 }, { t: 'well', x: 15.9, y: -6.6 }, { t: 'crates', x: 14.9, y: -0.35 }, { t: 'barrels', x: 17.2, y: -0.35 }, { t: 'logs', x: 29.9, y: 13.7 }, { t: 'logs', x: 28.75, y: 15.55 }, { t: 'shrine', x: 16.2, y: -4.3 }, { t: 'boatup', x: 34.4, y: 19.4 }, { t: 'nets', x: 36.4, y: 19.2 }, { t: 'boatup', x: 9.5, y: -2.7 }, { t: 'fishracks', x: 10.2, y: -1.8 }, { t: 'well', x: 26.9, y: 7.9 }, { t: 'stalls', x: 0.0, y: 0.0 },
  { t: 'cross', x: 9.9, y: 18.08 }, { t: 'crates', x: 10.9, y: 18.1 }, { t: 'ropes', x: 14.2, y: 17.92 }, { t: 'barrels', x: 18.9, y: 18.12 }, { t: 'sails', x: 25.0, y: 18.12 }, { t: 'crates', x: 26.6, y: 18.15 }, { t: 'barrels', x: 23.5, y: 18.08 }, { t: 'crates', x: 12.6, y: 18.12 }, { t: 'crane', x: 14.6, y: 18.78 }, { t: 'crane', x: 21.9, y: 18.78 }, { t: 'crates', x: 10.3, y: 18.95 }, { t: 'barrels', x: 12.1, y: 19.0 }, { t: 'logs', x: 16.1, y: 18.95 }, { t: 'crates', x: 17.2, y: 19.0 }, { t: 'nets', x: 20.2, y: 18.98 }, { t: 'barrels', x: 22.9, y: 19.0 }, { t: 'crates', x: 24.0, y: 18.92 }, { t: 'nets', x: 13.4, y: 18.98 },
];
