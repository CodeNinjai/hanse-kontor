...
HK.PROPS = [
  ...
  { t: 'crates', x: 22.1, y: 9.6 }, { t: 'barrels', x: 16.0, y: 4.7 }, { t: 'crates', x: 10.0, y: 18.15 }, { t: 'barrels', x: 23.5, y: 18.1 }, { t: 'crane', x: 20.4, y: 18.2 }, { t: 'crane', x: 9.3, y: 18.3 }, { t: 'crates', x: 12.0, y: 18.2 },
  ...
  { t: 'gallows', x: 30.6, y: 7.6 }, { t: 'tollbar', x: 29.6, y: 10 }, { t: 'well', x: 15.9, y: -6.6 }, { t: 'crates', x: 14.9, y: -0.35 }, { t: 'barrels', x: 17.2, y: -0.35 }, { t: 'logs', x: 29.9, y: 13.7 }, { t: 'logs', x: 28.6, y: 15.2 }, { t: 'shrine', x: 16.2, y: -4.3 }, { t: 'boatup', x: 34.4, y: 19.4 }, { t: 'nets', x: 36.4, y: 19.2 }, { t: 'boatup', x: 9.5, y: -2.7 }, { t: 'fishracks', x: 10.2, y: -1.8 }, { t: 'well', x: 26.9, y: 7.9 }, { t: 'crates', x: 26.6, y: 18.2 }, { t: 'barrels', x: 11.0, y: 18.15 }, { t: 'logs', x: 15.4, y: 18.25 }, { t: 'crates', x: 17.0, y: 18.2 }, { t: 'nets', x: 21.6, y: 18.3 }, { t: 'barrels', x: 13.9, y: 18.2 }, { t: 'crates', x: 22.6, y: 18.15 }, { t: 'logs', x: 24.0, y: 18.3 }, { t: 'nets', x: 12.7, y: 18.25 }, { t: 'barrels', x: 27.2, y: 18.25 }, { t: 'crates', x: 19.6, y: 18.3 },
  { t: 'stalls', x: 0, y: 0 },
];
