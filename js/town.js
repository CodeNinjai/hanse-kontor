...
HK.BUILDINGS = [
  ...
  { id: 'kontor',    kind: 'gable',  x: 7.4,  y: 7.9,  w: 1.7, d: 1.3, h: 1.3, wall: '#e4d8be', roof: '#8b4639', panel: 'kontor', name: { de: 'Dein Kontor', en: 'Your office' } },
  { id: 'customs',   kind: 'eave',   x: 7.4,  y: 11.0, w: 1.6, d: 1.3, h: 1.1, wall: '#d9cdb2', roof: '#665a4e', flagpole: true, panel: 'customs', name: { de: 'Zollhaus', en: 'Customs house' } },
  ...
  { id: 'rectory',   kind: 'eave',   x: 14.3, y: 3.8,  w: 0.8, d: 1.1, h: 0.9, wall: '#d8c7a1', roof: '#795442', panel: 'church', name: { de: 'Pfarrhaus', en: 'Rectory' } },
  // Block Gilde
  { id: 'guild',     kind: 'hall',   x: 16.2, y: 2.5,  w: 1.9, d: 1.5, h: 1.6, brick: true, banner: true, panel: 'guild', name: { de: 'Gildehaus', en: 'Guild hall' } },
  { id: 'f1',        kind: 'gable',  x: 18.5, y: 2.4,  w: 1.0, d: 1.1, h: 1.1, wall: '#e1d4b5', roof: '#8b4639', name: { de: 'Bürgerhaus', en: 'Townhouse' } },
  { id: 'f2',        kind: 'gable',  x: 19.7, y: 2.4,  w: 0.9, d: 1.1, h: 1.2, wall: '#d8c9a6', roof: '#795442', name: { de: 'Bürgerhaus', en: 'Townhouse' } },
  { id: 'f3',        kind: 'eave',   x: 18.5, y: 3.9,  w: 2.0, d: 0.9, h: 1.0, wall: '#dccfae', roof: '#844636', name: { de: 'Bürgerhaus', en: 'Townhouse' } },
  // Block Vogtei
  ...
  // Block Taverne
  { id: 'tavern',    kind: 'eave',   x: 16.2, y: 6.2,  w: 1.7, d: 1.3, h: 1.2, wall: '#c39a6c', roof: '#734a36', sign: 'tavern', panel: 'tavern', name: { de: 'Taverne „Zum Goldenen Hering“', en: 'The Golden Herring Tavern' } },
  { id: 'bank',      kind: 'eave',   x: 18.3, y: 6.2,  w: 1.4, d: 1.2, h: 1.3, wall: '#cfc6b4', roof: '#605449', stone: true, sign: 'bank', panel: 'bank', name: { de: 'Geldwechsler', en: 'Money changer' } },
  { id: 'house1',    kind: 'gable',  x: 16.2, y: 8.1,  w: 1.2, d: 1.2, h: 1.2, wall: '#e1d4b5', roof: '#8b4639', panel: 'house', plot: 0, name: { de: 'Haus am Kirchweg', en: 'Church Lane house' } },
  { id: 'house2',    kind: 'gable',  x: 17.7, y: 8.1,  w: 1.2, d: 1.2, h: 1.1, wall: '#d8c9a6', roof: '#795442', panel: 'house', plot: 1, name: { de: 'Haus zum Anker', en: 'Anchor house' } },
  { id: 'f4',        kind: 'gable',  x: 19.2, y: 8.1,  w: 1.2, d: 1.2, h: 1.2, wall: '#e6dbc2', roof: '#844636', name: { de: 'Bürgerhaus', en: 'Townhouse' } },
  { id: 'f5',        kind: 'eave',   x: 21.7, y: 6.2,  w: 1.6, d: 1.1, h: 1.1, wall: '#d6c8aa', roof: '#84503f', name: { de: 'Bürgerhaus', en: 'Townhouse' } },
  { id: 'f6',        kind: 'gable',  x: 21.7, y: 8.0,  w: 1.6, d: 1.2, h: 1.2, wall: '#e3d5b9', roof: '#65554f', name: { de: 'Bürgerhaus', en: 'Townhouse' } },
  // Block Süd-West
  { id: 'house3',    kind: 'eave',   x: 10.2, y: 10.7, w: 1.4, d: 1.2, h: 1.2, wall: '#e6dbc2', roof: '#8b4639', panel: 'house', plot: 2, name: { de: 'Giebelhaus', en: 'Gabled house' } },
  { id: 'house4',    kind: 'gable',  x: 11.9, y: 10.7, w: 1.3, d: 1.2, h: 1.3, wall: '#dccfae', roof: '#7e4634', panel: 'house', plot: 3, name: { de: 'Haus an der Hafenstraße', en: 'Harbour Street house' } },
  ...
  { id: 'bathhouse', kind: 'eave',   x: 10.2, y: 12.3, w: 1.6, d: 1.1, h: 1.1, wall: '#dbc2a7', roof: '#8f503a', panel: 'bathhouse', name: { de: 'Badehaus', en: 'Bathhouse' } },
  { id: 'f7',        kind: 'gable',  x: 12.1, y: 12.3, w: 1.2, d: 1.1, h: 1.2, wall: '#e1d4b5', roof: '#844636', name: { de: 'Bürgerhaus', en: 'Townhouse' } },
  { id: 'f8',        kind: 'gable',  x: 13.6, y: 12.3, w: 1.2, d: 1.1, h: 1.1, wall: '#d9c9a8', roof: '#8b4639', name: { de: 'Bürgerhaus', en: 'Townhouse' } },
  // Block Süd-Mitte
  ...
  { id: 'house5',    kind: 'gable',  x: 19.6, y: 10.7, w: 1.2, d: 1.2, h: 1.3, wall: '#dfcfaf', roof: '#7e4634', panel: 'house', plot: 4, name: { de: 'Speicherhaus', en: 'Storehouse' } },
  { id: 'f9',        kind: 'eave',   x: 16.2, y: 12.3, w: 1.4, d: 1.1, h: 1.1, wall: '#e3d5b9', roof: '#65554f', name: { de: 'Bürgerhaus', en: 'Townhouse' } },
  { id: 'f10',       kind: 'gable',  x: 17.9, y: 12.3, w: 1.3, d: 1.1, h: 1.2, wall: '#d9c9a8', roof: '#844636', name: { de: 'Bürgerhaus', en: 'Townhouse' } },
  { id: 'f11',       kind: 'eave',   x: 19.5, y: 12.3, w: 1.3, d: 1.1, h: 1.0, wall: '#e1d4b5', roof: '#8b4639', name: { de: 'Bürgerhaus', en: 'Townhouse' } },
  { id: 'f12',       kind: 'gable',  x: 21.7, y: 10.7, w: 1.6, d: 1.2, h: 1.2, wall: '#dccfae', roof: '#795442', name: { de: 'Bürgerhaus', en: 'Townhouse' } },
  { id: 'f13',       kind: 'eave',   x: 21.7, y: 12.4, w: 1.6, d: 1.0, h: 1.0, wall: '#e6dbc2', roof: '#844636', name: { de: 'Bürgerhaus', en: 'Townhouse' } },
  // Südzeile
  { id: 'f14',       kind: 'gable',  x: 10.2, y: 14.6, w: 1.3, d: 1.1, h: 1.2, wall: '#e1d4b5', roof: '#8b4639', name: { de: 'Bürgerhaus', en: 'Townhouse' } },
  { id: 'f15',       kind: 'eave',   x: 11.9, y: 14.6, w: 1.6, d: 1.1, h: 1.0, wall: '#d8c9a6', roof: '#65554f', name: { de: 'Bürgerhaus', en: 'Townhouse' } },
  { id: 'f16',       kind: 'gable',  x: 16.2, y: 14.6, w: 1.3, d: 1.1, h: 1.2, wall: '#dccfae', roof: '#844636', name: { de: 'Bürgerhaus', en: 'Townhouse' } },
  { id: 'f17',       kind: 'gable',  x: 17.9, y: 14.6, w: 1.3, d: 1.1, h: 1.1, wall: '#e6dbc2', roof: '#795442', name: { de: 'Bürgerhaus', en: 'Townhouse' } },
  { id: 'f18',       kind: 'eave',   x: 21.7, y: 14.6, w: 1.6, d: 1.1, h: 1.0, wall: '#e3d5b9', roof: '#8b4639', name: { de: 'Bürgerhaus', en: 'Townhouse' } },
  ...
  { id: 'dive',      kind: 'eave',   x: 12.3, y: 16.8, w: 1.4, d: 1.2, h: 1.0, wall: '#b9a07a', roof: '#634e40', shabby: true, sign: 'mug', panel: 'dive', name: { de: 'Spelunke „Zum Nassen Hund“', en: 'The Wet Dog dive' } },
  { id: 'ropewalk',  kind: 'longhouse', x: 14.0, y: 17.15, w: 3.2, d: 0.7, h: 0.6, wall: '#c9b48a', roof: '#7f6e4d', low: true, panel: 'venture', name: { de: 'Seilerei', en: 'Ropewalk' } },
  { id: 'cooper',    kind: 'eave',   x: 17.5, y: 16.8, w: 1.3, d: 1.2, h: 1.0, wall: '#d8c7a1', roof: '#795442', sign: 'barrel', panel: 'venture', name: { de: 'Böttcherei', en: 'Cooperage' } },
  { id: 'smokery',   kind: 'eave',   x: 19.1, y: 16.85, w: 1.4, d: 1.15, h: 1.0, wall: '#8a7a6a', roof: '#505050', bigChimney: true, sign: 'fish', panel: 'venture', name: { de: 'Fischräucherei', en: 'Fish smokery' } },
  ...
  { id: 'sailmaker', kind: 'eave',   x: 24.7, y: 16.85, w: 1.5, d: 1.15, h: 1.0, wall: '#e3d5b9', roof: '#65554f', sign: 'sail', panel: 'venture', name: { de: 'Segelmacherei', en: 'Sailmaker' } },
  { id: 'harbourmaster', kind: 'eave', x: 26.4, y: 16.8, w: 1.2, d: 1.2, h: 1.2, wall: '#cfc6b4', roof: '#605449', stone: true, flagpole: true, panel: 'harbourmaster', name: { de: 'Hafenmeisterei', en: "Harbour master's office" } },
  ...
  { id: 'bakery',    kind: 'gable',  x: 24.7, y: 5.7,  w: 1.1, d: 1.1, h: 1.0, wall: '#dfd1af', roof: '#8b4639', sign: 'pretzel', panel: 'venture', name: { de: 'Bäckerei', en: 'Bakery' } },
  { id: 'butcher',   kind: 'eave',   x: 26.1, y: 5.7,  w: 1.2, d: 1.1, h: 1.0, wall: '#d9c0b0', roof: '#795442', sign: 'cleaver', panel: 'venture', name: { de: 'Fleischerei', en: 'Butcher' } },
  { id: 'tannery',   kind: 'eave',   x: 26.4, y: 14.5, w: 1.0, d: 1.2, h: 0.9, wall: '#a08a6a', roof: '#6c5946', frames: true, panel: 'venture', name: { de: 'Gerberei', en: 'Tannery' } },
  ...
  { id: 'potter',    kind: 'gable',  x: 24.7, y: 12.9, w: 1.2, d: 1.0, h: 0.9, wall: '#dccfae', roof: '#844636', kiln: true, sign: 'pot', panel: 'venture', name: { de: 'Töpferei', en: 'Pottery' } },
  { id: 'dyer',      kind: 'eave',   x: 26.2, y: 12.9, w: 1.2, d: 1.1, h: 1.0, wall: '#d8c9a6', roof: '#605449', dyeCloths: true, panel: 'venture', name: { de: 'Färberei', en: 'Dye works' } },
  { id: 'school',    kind: 'school', x: 24.7, y: 14.5, w: 1.5, d: 1.2, h: 1.3, stone: true, wall: '#cfc6b4', roof: '#605449', sign: 'book', panel: 'school', name: { de: 'Lateinschule', en: 'Latin school' } },
  ...
  { id: 'weighhouse', kind: 'eave',  x: 16.9, y: -1.9, w: 1.5, d: 1.2, h: 1.3, stone: true, wall: '#cfc6b4', roof: '#605449', sign: 'scale', panel: 'weighhouse', name: { de: 'Stadtwaage', en: 'Weigh house' } },
  { id: 'f20',       kind: 'gable',  x: 18.7, y: -1.9, w: 1.1, d: 1.2, h: 1.1, wall: '#e1d4b5', roof: '#8b4639', name: { de: 'Bürgerhaus', en: 'Townhouse' } },
  { id: 'inn',       kind: 'eave',   x: 20.1, y: -1.9, w: 1.8, d: 1.2, h: 1.2, wall: '#c9b48a', roof: '#795442', sign: 'tavern', panel: 'venture', name: { de: 'Herberge „Zum Wegweiser“', en: 'The Signpost inn' } },
  { id: 'f21',       kind: 'gable',  x: 22.2, y: -1.9, w: 1.0, d: 1.1, h: 1.1, wall: '#d8c9a6', roof: '#65554f', name: { de: 'Bürgerhaus', en: 'Townhouse' } },
  { id: 'goldsmith', kind: 'gable',  x: 12.2, y: 0.95, w: 1.3, d: 0.9, h: 1.2, wall: '#e6dbc2', roof: '#605449', sign: 'ring', panel: 'venture', name: { de: 'Goldschmied', en: 'Goldsmith' } },
  { id: 'apothecary', kind: 'eave',  x: 13.8, y: 0.95, w: 1.3, d: 0.9, h: 1.1, wall: '#d9cdb2', roof: '#844636', sign: 'mortar', panel: 'venture', name: { de: 'Apotheke', en: 'Apothecary' } },
  { id: 'chapel',    kind: 'chapel', x: 16.6, y: 0.7,  w: 1.4, d: 1.1, h: 1.2, panel: 'chapel', name: { de: 'Kapelle St. Gertrud', en: "St Gertrude's chapel" } },
  { id: 'f22',       kind: 'gable',  x: 18.4, y: 0.95, w: 1.2, d: 0.9, h: 1.1, wall: '#dccfae', roof: '#8b4639', name: { de: 'Bürgerhaus', en: 'Townhouse' } },
  { id: 'f23',       kind: 'eave',   x: 19.9, y: 0.95, w: 1.5, d: 0.9, h: 1.0, wall: '#e3d5b9', roof: '#795442', name: { de: 'Bürgerhaus', en: 'Townhouse' } },
  { id: 'f24',       kind: 'gable',  x: 21.7, y: 0.95, w: 1.1, d: 0.9, h: 1.2, wall: '#e1d4b5', roof: '#844636', name: { de: 'Bürgerhaus', en: 'Townhouse' } },
  { id: 'f25',       kind: 'eave',   x: 24.6, y: 0.95, w: 1.4, d: 0.9, h: 1.0, wall: '#d6c8aa', roof: '#65554f', name: { de: 'Bürgerhaus', en: 'Townhouse' } },
  { id: 'f26',       kind: 'gable',  x: 26.3, y: 0.95, w: 1.0, d: 0.9, h: 1.1, wall: '#e6dbc2', roof: '#8b4639', name: { de: 'Bürgerhaus', en: 'Townhouse' } },
  ...
  { id: 'arsenal',   kind: 'hall',   x: 28.4, y: 16.2, w: 1.5, d: 1.3, h: 1.4, stone: true, wall: '#9a9284', roof: '#574e42', banner: 'red', panel: 'arsenal', name: { de: 'Zeughaus', en: 'Arsenal' } },
  { id: 'pilot',     kind: 'gable',  x: 30.2, y: 16.4, w: 1.0, d: 1.0, h: 1.0, wall: '#d9cdb2', roof: '#665a4e', sign: 'anchor', name: { de: 'Lotsenhaus', en: "Pilot's house" } },
