/* Stadtplan von Sundhaven in Weltkoordinaten (isometrisch).
   ...
   Innerhalb der Mauer: x 7..28, y 1.6..18.5. Nördlich der Mauer das Fischerdorf, östlich das Umland. */
'use strict';

HK.SCENE = { W: 1280, H: 800 };
HK.WORLD = { COAST_X: 7, COAST_Y: 18.5, WALL_N: 1.6, WALL_E: 28 };
...
HK.STREETS = [
  [9.5, 1.8, 9.5, 18.3, 0.9], [15.5, 0.2, 15.5, 18.3, 0.9], [21, 1.8, 21, 18.3, 0.8], [24, 1.8, 24, 18.3, 0.8], [27.5, 1.8, 27.5, 18.3, 0.5],
  [7.4, 5.5, 27.8, 5.5, 0.8], [7.4, 10, 27.8, 10, 0.9], [7.4, 14, 27.8, 14, 0.8], [7.4, 2.1, 27.8, 2.1, 0.6], [7.4, 16.2, 27.8, 16.2, 0.6],
  [27.8, 10, 34, 10, 0.9], [15.5, 0.2, 15.5, -3, 0.8], [8.2, 0.6, 8.2, -2.6, 0.5],
];
HK.ROAD_NODES = {
  ...
  E1: [27.5, 2.2], E2: [27.5, 5.5], E3: [27.5, 10], E4: [27.5, 14], E5: [27.5, 16.2], E6: [27.5, 18.3],
  S1: [12.6, 7.1], S2: [14.0, 7.1], S3: [12.9, 9.5], MK: [13, 10], N1: [12.6, 5.5],
  PA: [11.6, 21.4], PB: [18.6, 21.4], SP1: [11.6, 18.3], SP2: [18.6, 18.3], G: [29.2, 10], OUT: [31.5, 10], OUT2: [34, 10], NG: [15.5, 0.6], NG2: [15.5, -2.5],
...
HK.ROAD_EDGES = [
  ...
  ['Q3', 'H3'], ['H3', 'MK'], ['MK', 'M3'], ['M3', 'O3'], ['O3', 'C2'], ['C2', 'E3'], ['E3', 'G'], ['G', 'OUT'], ['OUT', 'OUT2'],
  ['Q4', 'H4'], ['H4', 'M4'], ['M4', 'O4'], ['O4', 'C3'], ['C3', 'E4'], ['Q5', 'H5'], ['H5', 'M5'], ['M5', 'O5'], ['O5', 'C4'], ['C4', 'E5'],
  ['Q6', 'H6'], ['H6', 'SP1'], ['SP1', 'M6'], ['M6', 'SP2'], ['SP2', 'O6'], ['O6', 'C5'], ['C5', 'E6'],
  ['S1', 'S2'], ['S2', 'M23'], ['S1', 'S3'], ['S2', 'S3'], ['S3', 'MK'], ['H2', 'N1'], ['N1', 'M2'], ['N1', 'S1'], ['PA', 'SP1'], ['PB', 'SP2'],
  ['M1', 'NG'], ['NG', 'NG2'], ['Q1', 'FV1'], ['FV1', 'FV2'], ['FV2', 'FV3'], ['FV2', 'FV4'],
];
...
HK.WINDMILL = { x: 31.3, y: 13.6 };
HK.FIELDS = [[29.2, 3.6, 2.4, 2.2], [29.4, 6.6, 2.2, 2.0], [28.9, 12.6, 1.6, 2.0], [29.6, 15.6, 1.8, 1.6]];
HK.FARM = { x: 30.6, y: 17.6, w: 1.4, d: 1.0, h: 0.9 };
HK.GALLOWS = { x: 30.3, y: 8.1 };
HK.TOLLBAR = { x: 29.4, y: 10 };
...
HK.TREES = [
  ...
  [29.2, 1.2, 0.6], [30.9, 0.6, 0.55], [32.3, 3.4, 0.6], [32.6, 6.4, 0.5], [32.6, 8.6, 0.55], [29.3, 9.0, 0.45], [30.0, 12.3, 0.5], [32.7, 12.4, 0.55], [33.2, 9.2, 0.5], [29.1, 14.9, 0.45], [33.0, 15.6, 0.6], [31.6, 16.8, 0.5], [28.8, 16.8, 0.45], [33.5, 13.5, 0.55], [34.2, 2.0, 0.6],
  [27.5, -1.2, 0.55], [23.5, -1.0, 0.5], [19.5, -1.4, 0.55], [11.5, -1.2, 0.5], [12.6, 0.2, 0.4], [21.5, 0.3, 0.4], [25.6, -0.2, 0.45], [10.4, -3.0, 0.45], [17.8, -3.2, 0.5], [31.0, -2.4, 0.55], [7.6, 0.5, 0.3],
];
HK.PROPS = [
  ...
  { t: 'gallows', x: 30.3, y: 8.1 }, { t: 'tollbar', x: 29.4, y: 10 }, { t: 'boatup', x: 9.5, y: -2.7 }, { t: 'fishracks', x: 10.2, y: -1.8 }, { t: 'well', x: 26.9, y: 7.9 }, { t: 'crates', x: 26.6, y: 18.2 },
  { t: 'stalls', x: 0, y: 0 },
];
